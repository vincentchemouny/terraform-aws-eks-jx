...
VARS="-var cluster_name=${CLUSTER_NAME} -var region=eu-west-3 -var vault_user=${VAULT_USER} -var vpc_name=${CLUSTER_NAME}-vpc"
...
curl -o aws-iam-authenticator https://amazon-eks.s3-eu-west-3.amazonaws.com/1.15.10/2020-02-22/bin/linux/amd64/aws-iam-authenticator
